...
const Stack = ({ techStack }) => {
    ...
    const stackIcons = {
        html: <HTML width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        css: <CSS width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        javascript: <JavaScript width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        typescript: <TypeScript width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        react: <ReactIcon width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        redux: <ReduxIcon width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        node: <NodeIcon width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        firebase: <Firebase width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        vercel: <Vercel width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        express: <Express width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />,
        figma: <Figma width={24} height={24} color={darkMode ? `white` : `var(--slate-black)`} />
    };
...
const ProjectList = [
    {
        ...
        description: 'A web application that allows users to generate AI-powered images and post them directly to Instagram. Deployed on Vercel with Firebase for file storage.',
    ...
    },
    {
        ...
        description: 'A web app to manage and track daily, weekly, and monthly tasks. Features include email verification, user authentication, and CRUD operations.',
    ...
    },
    {
        ...
        description: 'A website design for a company while working as a freelancer. This is a landing page for a startup which monitors the AQI through their product.',
...
const ProjectCards = ProjectList.map((project) => {
    const uniqueId = nanoid(10);
    return <Reveal key={uniqueId}><Card id={uniqueId} data={project} /></Reveal>;
});
...
const Projects = () => {
    ...
    return (
        <div className={`${darkMode ? styles.darkMode : ''} ${styles.projects}`} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            <div>
                <Reveal type="horizontal">
                    <MarkerHighlight color="rgba(230, 126, 34, 0.45)">
